...
`,
    ...
    for (const chunk of chunks) {
      ...
      assert(chunk.chunk);
      assert(
        chunk.chunk.chunkType === ChunkType.Semantic ||
          chunk.chunk.chunkType === ChunkType.Text ||
          chunk.chunk.chunkType === ChunkType.EndOfFile,
      );
  ...
  try {
    ...
    for await (const chunk of walkProject(tempDir)) {
      if (chunk.chunk.chunkType === ChunkType.EndOfFile) {
        ...
        assert(
          chunk.chunk.contentHash !== null && chunk.chunk.contentHash !== undefined,
          "EOF chunk should have contentHash",
        );
        ...
        assert(
          chunk.chunk.content === null || chunk.chunk.content === undefined,
          "Non-EOF chunks should not have content",
        );
        assert(
          chunk.chunk.contentHash === null || chunk.chunk.contentHash === undefined,
          "Non-EOF chunks should not have contentHash",
        );
      }
    }
