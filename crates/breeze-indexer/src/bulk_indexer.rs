...
impl BulkIndexer {
  ...
  pub async fn index_stream(
    ...
    let (chunks_replace_tx, chunks_replace_rx) = mpsc::channel::<crate::pipeline::ReplaceFileChunks>(100);
    ...
    let _replace_ok = replace_sink_result
