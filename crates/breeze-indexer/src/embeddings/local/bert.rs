...
use crate::embeddings::local::text::get_model_info_by_hf_id;
use crate::embeddings::local::utils::tokenize_batch;
use crate::embeddings::local::{normalize_l2, select_device};
...
impl BertEmbedder {
  ...
  fn embed_late_chunking(
    ...
    for mini_text_batch in text_batch.chunks(batch_size) {
      ...
      let token_ids_tensor = Tensor::new(token_ids_merged.as_slice(), device)?.unsqueeze(0)?;
