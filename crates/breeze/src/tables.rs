...
pub fn projects_render(projects: &[Project], columns: &[String], mode: OutputMode, headers: bool) -> Result<String, String> {
  render_projects_impl(projects, columns, mode, headers)
}

pub fn tasks_render(tasks: &[Task], columns: &[String], mode: OutputMode, headers: bool) -> Result<String, String> {
